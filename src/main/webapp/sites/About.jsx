        ...
        <Grid container spacing={16} justify="center" style={{height: '100%', width: '100%', margin: '0px'}}>
          ...
          <Grid item xs={12}>
            <Card>
              ...
              <CardContent>
                <Typography>
                  In jedem Kurs werden 10 - 30 verschiedene Übungen trainiert. Das Konzept wird jedes Mal individuell und neu für den Tag entwickelt.
                  Wichtig ist hierbei vor allem das Einbeziehen von funktionellen Übungen, die alltagsnah trainiert werden. Dabei werden auch Eigenschaften wie Koordination, Gleichgewicht, Beweglichkeit, Kraft und Schnelligkeit einbezogen und je nach Trainingsstand verbessert.
                </Typography>
                <Typography>
          ...
          <Grid item xs={12}>
            <Card>
              ...
              <CardContent>
                <Typography>
                  FreyRaum findest du in der Tangendorfer Straße 2a in 21442 Toppenstedt. Ein Großteil der Kurse findet ab August 2018 im ehemaligen „Blumenstübchen“ von Toppenstedt statt.
                  Parkplätze sind direkt vor der Tür vorhanden.
                </Typography>
                <Typography>
                  Während der Sommersaison kann es vereinzelt vorkommen, dass Kurse in „die Scheune“ verlegt werden. Diese befindet sich in der Hauptstraße 15 und war bis vor kurzem noch unser Hauptquartier.
                </Typography>
              </CardContent>
            </Card>
          </Grid>
